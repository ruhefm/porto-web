<template>
<nav v-scroll :class="{ 'backdrop-blur-sm shadow-lg': scrolled }" class="mx-auto w-full flex items-center justify-center text-white text-center overflow-x-auto select-none sticky top-0 z-50 transition-all duration-300 p-4">
